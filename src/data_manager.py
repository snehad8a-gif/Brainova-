...
# --- BRANDING UPDATE ---
# This sets the browser tab title and the page icon
st.set_page_config(page_title="Brainova", page_icon="🧠")
...
# --- UI HEADER ---
st.title("Brainova")
st.subheader(f"Learning Management System | Backend: {BACKEND_NAME}")
